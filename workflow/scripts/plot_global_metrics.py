...
graph_props = pd.read_csv(os.path.join(args.global_metrics_dir, "global_metrics.csv"))
with open(os.path.join(args.global_metrics_dir, "global_metric_ps.pkl"), "rb") as f:
    ps = pickle.load(f)
with open(os.path.join(args.global_metrics_dir, "global_metric_stats.pkl"), "rb") as f:
    stats = pickle.load(f)
...
fig.savefig(os.path.join(args.global_metrics_dir, "images", "global_metric_comparison.png"), bbox_inches='tight')