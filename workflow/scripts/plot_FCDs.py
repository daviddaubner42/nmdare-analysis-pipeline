...
# Load FCD results
with open(os.path.join(args.fcds_path, "FCDs.pkl"), "rb") as f:
    fcds = pickle.load(f)
with open(os.path.join(args.fcds_path, "FCD_hists.pkl"), "rb") as f:
    hists = pickle.load(f)
with open(os.path.join(args.fcds_path, "FCD_hists_regr.pkl"), "rb") as f:
...
fig.savefig(f"{args.fcds_path}/images/avg_FCD_hist_comparison.png", bbox_inches="tight")
...
fig.savefig(f"{args.fcds_path}/images/avg_FCD_hist_comparison_regr.png", bbox_inches="tight")