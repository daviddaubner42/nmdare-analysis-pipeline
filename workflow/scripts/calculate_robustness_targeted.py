...
parser = argparse.ArgumentParser(description="Calculate the robustness against targeted attacks for each subject's FC matrix")
...
for gd in np.arange(args.min_density, args.max_density + args.density_step, args.density_step):
    ...
    initial, frac, apl = networkx_robustness.simulate_degree_attack(G, attack_fraction=0.99999999)
