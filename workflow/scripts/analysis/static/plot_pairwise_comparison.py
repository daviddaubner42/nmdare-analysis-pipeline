...
avg_nmdare_fc = np.loadtxt(os.path.join(args.fc_dir, "task-rest_space-fsLR_seg-DesikanKilliany_den-91k_desc-reorderedAvgNmdareFc_relmat.tsv"), delimiter='\t')
avg_hc_fc = np.loadtxt(os.path.join(args.fc_dir, "task-rest_space-fsLR_seg-DesikanKilliany_den-91k_desc-reorderedAvgHcFc_relmat.tsv"), delimiter='\t')
...
fig.savefig(os.path.join(args.fc_dir, "figures", "task-rest_space-fsLR_seg-DesikanKilliany_den-91k_desc-avgFcComparison_figure.png"), bbox_inches='tight')

# Plot the significant differences between the average FC matrices, with network boundaries
with open(os.path.join(args.fc_dir, "task-rest_space-fsLR_seg-DesikanKilliany_den-91k_desc-reorderedPairwiseComparisonPvals_relmat.tsv"), "rb") as f:
    p_vals = np.loadtxt(f, delimiter='\t')
with open(os.path.join(args.fc_dir, "task-rest_space-fsLR_seg-DesikanKilliany_den-91k_desc-reorderedPairwiseComparisonPvalsFdr_relmat.tsv"), "rb") as f:
    stats = np.loadtxt(f, delimiter='\t')
with open(os.path.join(args.fc_dir, "task-rest_space-fsLR_seg-DesikanKilliany_den-91k_desc-reorderedPairwiseComparisonTestStats_relmat.tsv"), "rb") as f:    
...
fig.savefig(os.path.join(args.fc_dir, "figures", "task-rest_space-fsLR_seg-DesikanKilliany_den-91k_desc-pValsUncorrected_figure.png"), bbox_inches='tight')
...
fig.savefig(os.path.join(args.fc_dir, "figures", "task-rest_space-fsLR_seg-DesikanKilliany_den-91k_desc-pValsFdr_figure.png"), bbox_inches='tight')
...
sources = [
    "bids:static:task-rest_space-fsLR_seg-DesikanKilliany_den-91k_desc-reorderedAvgNmdareFc_relmat.tsv",
    "bids:static:task-rest_space-fsLR_seg-DesikanKilliany_den-91k_desc-reorderedAvgHcFc_relmat.tsv",
    "bids:static:task-rest_space-fsLR_seg-DesikanKilliany_den-91k_desc-reorderedPairwiseComparisonPvals_relmat.tsv",
    "bids:static:task-rest_space-fsLR_seg-DesikanKilliany_den-91k_desc-reorderedPairwiseComparisonPvalsFdr_relmat.tsv",
    "bids:static:task-rest_space-fsLR_seg-DesikanKilliany_den-91k_desc-reorderedPairwiseComparisonTestStats_relmat.tsv"
]

with open(os.path.join(args.fc_dir, "figures", "task-rest_space-fsLR_seg-DesikanKilliany_den-91k_desc-pValsUncorrected_figure.json"), "w") as f:
    json.dump(sidecar, f)
with open(os.path.join(args.fc_dir, "figures", "task-rest_space-fsLR_seg-DesikanKilliany_den-91k_desc-pValsFdr_figure.json"), "w") as f:
    json.dump(sidecar, f)
with open(os.path.join(args.fc_dir, "figures", "task-rest_space-fsLR_seg-DesikanKilliany_den-91k_desc-avgFcComparison_figure.json"), "w") as f:
    json.dump(sidecar, f)